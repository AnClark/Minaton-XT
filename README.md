...
- **Further development:** A bunch of work to make Minaton work in modern hosts, including essential bug fixes. For instance:
  ...
  - Read OSC/LFO wave samples from memory
  - ... and so on.
...
- **Embedded resources:** Everything is in a single plug-in file, including artworks, wave samples and bundled presets

## Build Instructions

### 1. Clone source tree

Source tree has two submodules: DPF and DPF-Widgets.
...
User manual is integrated in Minaton-XT. You can click "Help" button (below the "Minaton" logo) to get access to the user manual.

The best start point is to try factory presets. Click "Presets" button to check out more than 20 factory presets. Have fun!
